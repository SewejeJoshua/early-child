          ...
          <StaggerContainer className="space-y-5" staggerDelay={0.12}>
            {values.map((item) => (
              <StaggerItem key={item.title}>
                <div className="flex gap-5 bg-card rounded-xl p-6 border border-border shadow-soft hover:shadow-card transition-all duration-300 group">
                  ...
                  <div>
                    <h3 className="font-display text-base font-700  mb-1.5">{item.title}</h3>
